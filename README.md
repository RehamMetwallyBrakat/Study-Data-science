      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              <span dir="rtl" >ونحن نطرح على أنفسنا أسئلة مثل ما هي الفرصة المتاحة النجاح وما هو الاحتمال الذي نفشل فيه
                حدد ما إذا كانت المخاطرة تستحق المخاطرة</span>
            </h3>
          </a>
        </div>
        <hr>
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              يحتاج العديد من <span dir="ltr">CEOS</span>
...
و اتخاذ القرار الصحيح لشركتهم
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Probability:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Academic definition:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Event:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Examples:</span><br>
              Flipping a coin<br>
              Rolling a six sided die<br>
              Running a mile in under 6 minutes

            </h2>
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              قلب عملة معدنية<br>
              دحرجة نرد من ستة جوانب<br>
...
0 يعبر عن اليقين المطلق بعدم وقوع الحدث
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              The probability of an event A occurring denoted<br>
              <span style="color:#C70039">P(A)=the number of preferred outcomes/total number of
                possible outcomes</span>

            </h2>
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              <span dir="rtl">P(A)=عدد النواتج المفضلة/إجمالي عدد
                النواتج المحتملة</span>
            </h3>
          </a>
        </div>
        <hr>
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Sample Space:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Example:</span><br>
                Flipping a coin and getting heads
            </h2>
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              preferred outcome = 1 <br>
              sample space = 2<br>
              P(H)=1/2=0.5
            </h3>
          </a>
        ...
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              preferred outcome = 2 [3 and 6] <br>
              sample space = 6<br>
              P(H)=2/6=0.33
            </h3>
          </a>
...
يساوي ناتج ضرب جميع احتمالات الأحداث كلا على حده
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">For instance:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Expected values:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">An experiment:</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">For example:</span><br>
...
هي تجربة واحدة تحتوي على 20 محاولة.
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Experimental probabilities:</span><br>
...
تطبق على الاحتمالات النظرية [عدد المحاولات الناجحه مقسموما على العدد الكلى للمحاولات]
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">The expected value of an event E(A):</span><br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">For instance:</span><br>
              You are trying to hit a target with a bow and arrow the target has three layers<br>
              The outermost one is worth 10 points<br>
              The second one is worth 20 points<br>
              and the bullseye is worth 100
            </h2>
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              The probability of hitting each layer is as follows<br>
              P(10) = 0.5<br>
              P(20) = 0.4<br>
              P(100) =  0.1<br>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Why is it important to know what the expected value of an event?</span><br>
              You are trying to hit a target with a bow and arrow the target has three layers<br>
              The outermost one is worth 10 points<br>
              The second one is worth 20 points<br>
              and the bullseye is worth 100
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Meteorologists often use these when forecasting the weather</span><br>
...
فهم لا يعرفون بالضبط كم الأمطار الثلجية أو الرياح هناك ستكون
              لذا فهي تزودنا ب<span dir="rtl"> interval </span>  محتملة بدلاً من ذلك
            </h3>
          </a>
        </div>
        <hr>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">Frequency:</span><br>
        ...
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              That gives us a total of six times six equals 36 different outcomes for the two roles<br>
              we can write out the results in a 6 * 6 table where rewrite the sum of the two dice
            </h3>
            <img src="img/6_6.PNG" width="300" height="300" style="display:block;margin-left: auto;margin-right: auto;"/>
            <h3 class="post-subtitle">
              Notice how 7 occurs 6 times in the table so the chance of getting a seven<br>
              This means:<br>
              favorable outcomes = 6<br>
              total possible outcomes = 36<br>
              P(7) = 6/36 = 1/6 <br>
            </h3>
          </a>
        </div>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">A frequency distribution table:</span><br>
            ...
            <img src="img/f_f.PNG" width="300" height="300" style="display:block;margin-left: auto;margin-right: auto;"/>
        ...
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              <span style="color:#C70039">A probability frequency distribution:</span><br>
        ...
        <div class="post-preview">
          <a>
            ...
            <div style="text-align:center;">
              <img src="img/p_p.PNG" width="40%" height="300"
                   style="display: inline-block;margin-left: auto;margin-right: auto;"/>
              <img src="img/g_g.PNG" width="40%" height="300"
                   style="display: inline-block;margin-left: auto;margin-right: auto;"/>
            </div>
            <h2 class="post-title">
              <span style="color:#C70039">On the graph we see the probability frequency distribution:</span><br>
              The x axis depicts the different possible numbers of spades we can get and<br>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              ...
              يصف المحور <span dir="rtl"> x </span> الأعداد المحتملة المختلفة من البستوني يمكننا الحصول على و
يمثل المحور <span dir="rtl"> y </span> احتمال الحصول على كل ناتج عند وضع التوقعات
            </h3>
...
هُوَ الْآحَادُ بِأَعْلِيِّ الْأَعْمِدَةِ فِي التَّمْثِيلِ الْ وعادة ما تكون أعلى <span dir="rtl"> bar </span>
...
<!--              هو مجموعة من الاحتمالات لكل ناتج محتمل-->
<!--            </h3>-->
<!--            <img src="img/p_p.PNG" width="300" height="300" style="display:block;margin-left: auto;margin-right: auto;"/>-->
<!--          </a>-->
<!--        </div>-->
<!--        <hr>-->
<!--        <div class="post-preview">-->
...
<!--        </div>-->
        ...
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle" style="color:#ff608d;font-family:'system-ui'">
              وهذا يشير إلى أننا إذا أردنا أن يكون <span dir="rtl"> interval </span> مع الاحتمال الأكبر  ينبغي لنا أن نبنيه من حول
القيمة المتوقعة
            </h3>
          </a>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Copyright &copy; Reham Metwally 2020</p>
        </div>
      </div>
    </div>
  </footer>
